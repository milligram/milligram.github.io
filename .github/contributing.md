...
[Open an Issue](https://github.com/milligram/milligram.github.io/issues/new) to report any problems or improvements. When necessary, use [Codepen](http://codepen.io/) to show the problem. Be sure to include some description to explain the problem.
...
1. Fork the Github repo: `git clone https://github.com/milligram/milligram.github.io.git`
